...
import { ArrowRight, Star, Users, BookOpen, Award, Target, Clock, CheckCircle } from 'lucide-react'
  ...
  const features = [
    {
      ...
      description: 'Learn from industry professionals with years of experience in communication and leadership.',
      link: '/workshops',
    ...
    },
    {
      ...
      description: 'Intimate workshop settings ensure personalized attention and meaningful interactions.',
      link: '/about',
      linkText: 'Learn More'
    },
    {
      ...
      description: 'Earn professional certifications that enhance your career prospects and credibility.',
      link: '/workshops',
    ...
    },
    {
      icon: Target,
      title: 'Career Growth',
      description: 'Transform your professional trajectory with skills that matter in today\'s competitive market.',
      link: '/contact',
  ...
  const testimonials = [
    {
      ...
      company: 'TechCorp',
      content: 'The leadership communication workshop transformed how I present to executives. My confidence has skyrocketed!',
      rating: 5
    },
    {
      name: 'Michael Chen',
      ...
      content: 'Communication Wave helped me become a more effective team leader. The practical techniques are game-changing.',
      rating: 5
    },
    {
      ...
      role: 'Sales Manager',
      company: 'GrowthCo',
      content: 'The public speaking workshop was exactly what I needed. I now lead presentations with confidence and clarity.',
      rating: 5
    }
  ]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-text-primary/70 max-w-3xl mx-auto">
              Our professional development programs are designed to deliver real results for your career growth.
            </p>
          </motion.div>
      ...
      <section className="py-16 md:py-20 bg-bg-secondary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-text-primary/70">
              Real feedback from professionals who have transformed their careers with us.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <p className="text-text-primary/70 mb-6 italic text-lg leading-relaxed">
                  "{testimonial.content}"
                </p>
                <div>
                  <div className="font-semibold text-text-primary text-lg">{testimonial.name}</div>
                  <div className="text-text-primary/60">{testimonial.role}, {testimonial.company}</div>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-text-primary/70 mb-8 leading-relaxed">
                Join thousands of professionals who have already transformed their careers with our proven methodology. 
                Our workshops combine cutting-edge techniques with practical application.
              </p>
            ...
            >
              <div className="text-center mb-8">
                ...
                <p className="text-text-primary/70 mb-6">
                  Limited seats available for our upcoming professional development intensive.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center py-3 border-b border-bg-light">
                  ...
                  <span className="font-semibold text-text-primary">3 Days</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-bg-light">
                  <span className="text-text-primary/70">Format</span>
                  <span className="font-semibold text-text-primary">In-Person</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-bg-light">
                ...
                <div className="flex justify-between items-center py-3">
                  ...
                  <span className="font-semibold text-text-primary">$1,299</span>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-white/90 mb-8 max-w-3xl mx-auto">
              Join our professional development workshops and take your communication skills to the next level.
            </p>
